        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="flex flex-col space-y-8">
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-4" id="download">
              <a 
                href="#" 
                className="group bg-black hover:bg-gray-800 text-white font-semibold px-8 py-4 rounded-2xl flex items-center justify-center gap-3 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
              ...
              <a 
                href="#" 
                className="group bg-white border-2 border-gray-300 hover:border-black text-gray-700 hover:text-black font-semibold px-8 py-4 rounded-2xl flex items-center justify-center gap-3 transition-all duration-300 transform hover:scale-105 shadow-lg"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="flex justify-center">
            <div className="relative w-72 h-[600px] md:w-96 md:h-[680px]">
              {/* Clean Container */}
              <div className="absolute inset-0 bg-gray-100 rounded-3xl -rotate-6"></div>
              <div className="absolute inset-0 bg-white border-2 border-gray-200 rounded-3xl shadow-2xl flex items-center justify-center p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <Image 
                  src={motokaIcon} 
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="flex justify-center mb-16">
            <div className="bg-white p-2 rounded-2xl shadow-lg border border-gray-200 inline-flex">
              <button 
                id="motoboy-btn"
                className="px-8 py-4 rounded-xl font-semibold transition-all duration-300 bg-black text-white"
                onClick={() => {
              ...
              <button 
                ...
                className="px-8 py-4 rounded-xl font-semibold transition-all duration-300 text-gray-600 hover:text-black bg-white"
                onClick={() => {
                  const motoboyBtn = document.getElementById('motoboy-btn');
                  const establishmentBtn = document.getElementById('establishment-btn');
                  const motoboySteps = document.getElementById('motoboy-steps');
          ...
          {/* Motoboy Steps */}
          <div id="motoboy-steps" className="max-w-5xl mx-auto">
      ...
      <section className="py-20 bg-black" id="contact">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <a 
            ...
            className="group bg-green-500 hover:bg-green-600 text-white font-bold px-10 py-5 rounded-2xl inline-flex items-center gap-4 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-xl text-lg"
          >
